...
https://wikimedia.org/api/rest_v1/media/math/render/svg/50f2b5077f8fa933c912c6ca0571d6c7d3709d83
$${\displaystyle f(x)={\begin{cases}1&amp;{\text{si }}w\cdot x-u&gt;0\\0&amp;{\text{en otro caso}}\end{cases}}}$$
